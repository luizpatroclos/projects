...
//The @Controller annotation allows autodetection of component classes in the classpath 
//and auto-registering bean definitions for them. The Java class annotated with @Controller is capable of handling multiple request mappings.
@Controller
