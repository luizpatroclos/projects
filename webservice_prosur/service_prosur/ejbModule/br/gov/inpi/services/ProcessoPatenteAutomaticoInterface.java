...
@Local
public interface ProcessoPatenteAutomaticoInterface {
	...
	public abstract List<DiPedido> pesquisarPedidosDiPorSemana();
	
	
	public abstract List<DiPedido> pesquisarPedidosDiRetroativa();
	
	
	public abstract List<PtnPedido> pesquisarPedidosDePatentePorSemana();
	
	
	public abstract List<PtnPedido> pesquisarPedidosDePatenteRetroativa();
	...
	/***
	 * 
	 * Pesquisa os autores de um pedido de Desenho Industrial que não estejam
