...
//
//@Stateless(name = "EntityFacadeMarcas")
//public class EntityFacadeMarcas implements EntityInterfaceMarcas {
//
//	@PersistenceContext(unitName = "prosur_marcas")
//	protected EntityManager entityManager;
//
//	private static final Logger LOGGER = Logger.getLogger(EntityFacadeMarcas.class);
//
//	protected EntityManagerFactory entityManagerFactory;
//
//	// private String persistenceUnitName = "prosur_marcas";
//
//	public EntityFacadeMarcas() {
//
//		/*
//		 * if (this.entityManagerFactory == null) this.entityManagerFactory =
//		 * Persistence.createEntityManagerFactory(persistenceUnitName); entityManager =
...
//			strBuilder.append(" SELECT FIRST 20000 DISTINCT mp.cd_process,  mp.no_process, mp.dt_deposit_process, ");
...
//			strBuilder.append(" WHERE md.no_rpi = '2274'");
