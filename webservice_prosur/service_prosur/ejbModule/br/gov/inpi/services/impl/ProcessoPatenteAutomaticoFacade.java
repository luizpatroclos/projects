...
@Stateless(name = "ProcessoPatenteAutomaticoFacade")
public class ProcessoPatenteAutomaticoFacade implements ProcessoPatenteAutomaticoInterface {

	private static final Logger LOGGER = Logger.getLogger(ProcessoPatenteAutomaticoFacade.class);
	...
	public ProcessoPatenteAutomaticoFacade() {}
	...
	public List<DiPedido> pesquisarPedidosDiPorSemana() {
	   ...
	   try{
		   ...
		   strBuilder.append(" SELECT FIRST 10 DISTINCT di.cod_pedido, di.cod_situacao, di.num_pedido, ");
	...
	public List<DiPedido> pesquisarPedidosDiRetroativa() {
		   ...
		   try{
			   ...
			   StringBuilder strBuilder = new StringBuilder();
			   strBuilder.append(" SELECT FIRST 5 di.cod_pedido, di.cod_situacao, di.num_pedido, ");
			   strBuilder.append(" di.dt_deposito, di.cod_natureza, di.cd_tipo_pedido, di.titulo,  ");
			   strBuilder.append(" di.dt_fase_nacional  ");
	...
	public List<PtnPedido> pesquisarPedidosDePatentePorSemana() {
		...
		try{
			...
			StringBuilder strBuilder = new StringBuilder();
    		strBuilder.append(" SELECT FIRST 10 ped.cod_pedido, ped.cod_situacao, ped.num_pedido, ");
	...
	public List<PtnPedido> pesquisarPedidosDePatenteRetroativa() {
		...
		try{
			...
			StringBuilder strBuilder = new StringBuilder();
    		strBuilder.append(" SELECT FIRST 5 ped.cod_pedido, ped.cod_situacao, ped.num_pedido, ");
    		strBuilder.append(" ped.dt_deposito ,ped.cod_natureza, ");
    		strBuilder.append("  ped.cd_tipo_pedido, ped.titulo, ped.dt_fase_nacional");
