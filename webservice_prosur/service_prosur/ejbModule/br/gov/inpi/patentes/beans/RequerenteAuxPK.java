 ...
 */
@Embeddable
public class RequerenteAuxPK implements Serializable {
    ...
    public RequerenteAuxPK() {
    }

    public RequerenteAuxPK(int codPedido, int codRequerente, Date dtInicio) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RequerenteAuxPK)) {
            return false;
        }
        RequerenteAuxPK other = (RequerenteAuxPK) object;
    ...
    public String toString() {
        return "br.gov.inpi.patente.model.RequerenteAuxPK[ codPedido=" + codPedido + ", codRequerente=" + codRequerente + ", dtInicio=" + dtInicio + " ]";
    }
